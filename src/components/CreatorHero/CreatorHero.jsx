...
const Creator = () => {
  ...
  return (
    <section
      ref={ref}
      className="relative text-offwhite px-2 md:py-10 sm:py-28 md:py-0 sm:px-6 flex flex-col items-center justify-center text-center"

    >
      {/* Heading */}
      <motion.h1
        className="font-cinzel text-3xl px-6 sm:text-4xl md:text-6xl text-yellowTint mb-4 mt-4"
      ...
      {/* Subheading */}
      <motion.h2
        className="text-base sm:text-lg md:text-lg text-white mb-6 px-8 leading-relaxed"
        initial={{ opacity: 0, y: 30 }}
        animate={{ opacity: inView ? 1 : 0, y: inView ? 0 : 30 }}
      ...
      {/* Paragraph */}
      <motion.p
        className="text-white text-base sm:text-lg md:text-xl max-w-4xl text-justify md:text-center mb-0 px-6 sm:px-0 leading-relaxed tracking-wide"
