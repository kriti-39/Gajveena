...
const CraftingOfGajveena = () => {
  ...
  return (
    ...
    >
      {/* Heading */}
      <motion.h2
        className="font-cinzel text-3xl sm:text-4xl md:text-6xl text-yellowTint text-center mb-4 mt-4"
      ...
      {/* Two-column grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mb-12 md:mb-20 max-w-6xl w-full">
        {/* Column 1 */}
        <motion.div
        ...
        >
          ...
          />
          <p className="text-lg md:text-xl text-white-300 max-w-xs">Rudra Veena</p>
        </motion.div>
